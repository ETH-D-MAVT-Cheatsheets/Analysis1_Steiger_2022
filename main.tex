...
\author{Micha Bosshart - bmicha@ethz.ch\\\footnotesize Ergänzt von N. Sendlhofer - nsendlhofer \& C. Leser - cleser}
\title{Analysis I}
...
\begin{document}
    \section{Funktionen}
        ...
        \input{src/Funktionen/bernoulli_hopital.tex}
    ...
    \section{Potenzreihen}
        \input{src/Potenzreihen/allgemein.tex}
        \input{src/Potenzreihen/konvergenzradius.tex}
        \input{src/Potenzreihen/taylorreihen.tex}

        \newpage
    \section{Trigonometrie}
        \input{src/Trigonometrie/tabelle.tex}
        % \input{src/Trigonometrie/einheitskreis.tex}
        \input{src/Trigonometrie/rechenregeln.tex}
        \input{src/Trigonometrie/funktionsmodifikation.tex}
    % \cbreak
    ...
    %     \input{src/Mehrdimensionale-Funktionen_Differentialrechnung/gradient.tex}
    ...
    %     \input{src/Vektoranalysis/allgemein.tex}
    ...
    %     \input{src/Differentialgleichungen/allgemein.tex}
    ...
    \input{src/Appendix/polynome_nten_grades.tex}
    \input{src/Appendix/wichtige_grenzwerte.tex}
    \input{src/Appendix/reihenentwicklung.tex}
    \input{src/Appendix/wichtige_integrale.tex}
    \input{src/Appendix/ableitung_un_gerade_fkt.tex}
    \input{src/Appendix/exponentialgesetze.tex}
    \input{src/Appendix/polarkoordinaten.tex}

    \newpage

    \section{Parametrisierungen}
        \input{src/Parametrisierungen/parametrisierungen.tex}
        \input{src/Parametrisierungen/normal_tangentialvektoren.tex}
    ...
    \section{Appendix B}
        \input{src/Appendix/haeufige_parametrisierungen.tex}
        \vfill \null \columnbreak
        \input{src/Appendix/haeufige_funktionsgraphen.tex}
